    ...
    public class TouchController : MonoBehaviour {
        ...
        void Update() {
            ...
            if (!dragging && controller.GetPressDown(triggerButton) && !controller.GetPress(touchPadButton)) {
                ...
                if (pickup != null && pickup.GetComponent<Touchable>()) {
                    pickup.GetComponent<Touchable>().onTriggerDown.Invoke(spawnPoint.transform, (int)trackedObj.index);
            ...
            if (controller.GetPressUp(triggerButton)) {
                if (pickup != null && pickup.GetComponent<Touchable>() && pickup.GetComponent<Touchable>().onTriggerUp != null) {
                    pickup.GetComponent<Touchable>().onTriggerUp.Invoke(spawnPoint.transform, (int)trackedObj.index);
                    triggerDown = false;
            ...
            if (controller.GetPressDown(gripButton) && pickup != null) {
                ...
                if (pickup.GetComponent<Grabbable>()) {
                    pickup.GetComponent<Grabbable>().onGrabStart.Invoke(spawnPoint.transform, (int)trackedObj.index);
                    dragging = true;
            ...
            if (dragging && pickup.GetComponent<Grabbable>()) {
                pickup.GetComponent<Grabbable>().onGrabUpdate.Invoke(spawnPoint.transform, (int)trackedObj.index);
            }

            if (triggerDown && pickup && pickup.GetComponent<Touchable>()) {
                if (pickup.GetComponent<Touchable>().onTriggerUpdate != null)
                    pickup.GetComponent<Touchable>().onTriggerUpdate.Invoke(spawnPoint.transform, (int)trackedObj.index);
            }
            ...
            if (controller.GetPressUp(gripButton) && pickup != null && dragging == true) {
                ...
                if (pickup.GetComponent<Grabbable>()) {
                    pickup.GetComponent<Grabbable>().onGrabEnd.Invoke(spawnPoint.transform, (int)trackedObj.index);
                    dragging = false;
        ...
        private void OnTriggerEnter(Collider collider) {
            if (collider.GetComponent<Touchable>()) {
                collider.GetComponent<Touchable>().onSelected.Invoke();
                collider.GetComponent<Touchable>().onSelectedEnter.Invoke(spawnPoint.transform, (int)trackedObj.index);
            }
        ...
        private void OnTriggerStay(Collider collider) {
            if (collider.GetComponent<Touchable>()) {
                collider.GetComponent<Touchable>().onSelectedUpdate.Invoke(spawnPoint.transform, (int)trackedObj.index);
            }
        }

        private void OnTriggerExit(Collider collider) {
            if (collider.GetComponent<Touchable>()) {
                collider.GetComponent<Touchable>().onUnSelected.Invoke();
                collider.GetComponent<Touchable>().onSelectedExit.Invoke(spawnPoint.transform, (int)trackedObj.index);
            }
            if (!dragging && !triggerDown) {
