...
[CustomEditor(typeof(PhysicalToggleButton))]
[CanEditMultipleObjects]

public class PhysicalToggleButtonEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (EditorGUI.EndChangeCheck()) {
            if (target.GetType() == typeof(PhysicalToggleButton)) {
                PhysicalToggleButton physicalToggleButtonController = (PhysicalToggleButton)target;
        ...
        if (GUILayout.Button("Force Reinitialize")) {
            if (target.GetType() == typeof(PhysicalToggleButton)) {
                PhysicalToggleButton physicalToggleButton = (PhysicalToggleButton)target;
                physicalToggleButton.Initialize(true);
            }
        }
    }
}
